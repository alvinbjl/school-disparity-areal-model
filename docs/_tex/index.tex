...
\urlstyle{same}
\hypersetup{
  pdftitle={Bayesian Spatial Modeling of School Disparities in Brunei Darussalam},
...
\phantomsection\label{cell-fig-sch}
\begin{figure}[H]
...
\phantomsection\label{cell-fig-ra}
\begin{figure}[H]
...
\phantomsection\label{cell-fig-exc}
\begin{figure}[H]
...
\phantomsection\label{cell-fig-res}
\begin{figure}[H]
...
than coastal areas with larger population suggests that school
